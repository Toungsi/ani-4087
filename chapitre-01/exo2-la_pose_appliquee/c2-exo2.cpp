...
// Rotation d'un vecteur par un quaternion unitaire : v' = q * v * q^-1,
// via la formule sans construction de matrice :
...
int main() {
    ...
    // Ordre de lecture fixé : position (x y z) puis quaternion (w x y z)
    ...
    Vec3 resultat = appliquer(pose, point);
